      ...
      <main className="flex-1 px-6 py-6 max-w-4xl mx-auto w-full space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-xs border border-amber-200 bg-amber-50 text-amber-800 rounded-full px-3 py-1.5 hover:bg-amber-100 transition-colors w-fit"
          >
        ...
        <div className="border rounded-lg p-4 space-y-3">
          ...
          >
            ...
            {showSpec ? "Hide" : "View"} actual 402 response
            {showSpec ? (
