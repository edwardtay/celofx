            ...
            "application/json": {
              schema: {
                ...
                properties: {
                  ...
                  orderId: { type: "string", description: "Required when action=cancel" },
                  signature: { type: "string", description: "Wallet signature over action payload" },
                  nonce: { type: "string", description: "One-time nonce for replay protection" },
                  timestamp: { type: "number", description: "Unix ms timestamp in signed payload" },
                },
                required: ["action", "creator", "signature", "nonce", "timestamp"],
              },
            },
          },
        },
